...
const Products = ({ cart, setCart }) => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-semibold mb-5 text-center">Products</h2>
      <div className="grid grid-cols-1 sm:grid-cols-4 ml-48 gap-4">
        {sampleProducts.map((product) => (
          <div key={product.id} className="border border-y-2 shadow-md p-4 w-48 mb-20 rounded text-center">
            <img src={product.image} alt="" className="w-40 h-56  "></img>
